...
# from conf.config import   flattrade_api, nifty_fut_token, dhan_api, feed_folder, optionUpdateObj
...
# marketAnalysis.run()
    ...
    def start_flattrade_websocket(self):
        ...
        # thread.start()
        self.setupWebSocket()
        logger.info("flattrade websocket started")
        self.flattrade_api.subscribe("NSE|26000")
        self.flattrade_api.subscribe("NFO|"+ str(self.nifty_fut_token))
